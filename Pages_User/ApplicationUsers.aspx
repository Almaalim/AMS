                ...
                <div class="col12">
                    ...
                    <asp:GridView ID="grdData" runat="server" CssClass="datatable" SelectedIndex="0"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Start Date" meta:resourcekey="TemplateFieldResource1">
                                <ItemTemplate>
                                    <%# DisplayFun.GrdDisplayDate(Eval("UsrStartDate"))%>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Expiry Date" meta:resourcekey="TemplateFieldResource2">
                                <ItemTemplate>
