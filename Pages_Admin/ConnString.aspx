<%@ Page Title="" Language="C#" MasterPageFile="~/AMSMasterPage.master" AutoEventWireup="true" CodeFile="ConnString.aspx.cs" Inherits="ConnString" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            ...
            <div class="row">
                  <div class="col2"></div>
                <div class="col8">
                                                <asp:CheckBox ID="chkEncrypt" runat="server" Text="Encrypt Connection String" />
                                            </div>
                </div>
            <div class="row">
                <div class="col2">
            ...
            <div class="row">
                ...
                <div class="col4">
                                    <asp:TextBox ID="txtPassword" runat="server" AutoCompleteType="Disabled" TextMode="Password"></asp:TextBox>
                ...
                <div class="col4">
                                    <asp:TextBox ID="txtDatabaseName" runat="server" AutoCompleteType="Disabled"></asp:TextBox>
