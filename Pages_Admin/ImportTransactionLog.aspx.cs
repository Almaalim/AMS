...
public partial class Pages_Admin_ImportTransactionLog : BasePage
{
    
    ...
    string MainQuery = " SELECT * FROM ImportLog ";
    
    ...
    public string GetType(object type)
    {
        ...
        if (type.ToString() == "A") { return General.Msg("Schedule","جدولة"); }
        else if (type.ToString() == "M") { return General.Msg("Manual","يدوي"); }
    ...
    protected void btnFilter_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            //FQ.Append(MainQuery);
            //FQ.Append(" WHERE IplDate BETWEEN @SDate AND @EDate ");
            //FQ.Append(" ORDER BY IplDate DESC ");
            //cmd.Parameters.AddWithValue("@SDate", SDate);
            //cmd.Parameters.AddWithValue("@EDate", EDate);
            //sql = FQ.ToString();

            FQ.Append(" IplDate >= '" + SDate + "' AND IplDate <= '" + EDate + "' ");
