                                            ...
                                            <as:GridViewKeyBoardPagerExtender ID="gridviewextender" runat="server" TargetControlID="grdData" NextRowSelectKey="Add" 
                                                ...
                                                OnRowDataBound="grdData_RowDataBound" OnSelectedIndexChanged="grdData_SelectedIndexChanged"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="EvrID" HeaderText="Evr ID" SortExpression="EvrID" meta:resourcekey="BoundFieldResource2" 
                                                            ></asp:BoundField>
            ...
            <div class="GreySetion">
                <div class="row">
                    ...
                    <div class="col4">
                        ...
                        <asp:RequiredFieldValidator ID="rvEmpID" runat="server" ControlToValidate="txtEmpID"
                            EnableClientScript="False" Text="&lt;img src='../images/Exclamation.gif' title='Emloyee ID is required!' /&gt;"
                            ValidationGroup="vgSave" meta:resourcekey="rvEmpIDResource1" CssClass="CustomValidator"></asp:RequiredFieldValidator>
                        <asp:CustomValidator id="cvFindEmp" runat="server"
                            ...
                            ControlToValidate="txtValid" meta:resourcekey="cvFindEmpResource1" CssClass="CustomValidator"></asp:CustomValidator>
                ...
                <div class="row">
                    ...
                    <div class="col2">
                        <span class="RequiredField">*</span>
                        <asp:Label ID="lblEndDate" runat="server" Text="End Date:" meta:resourcekey="lblEndDateResource1" 
                            ></asp:Label>
                    </div>
                    <div class="col4">
                ...
                <div class="row">
                    ...
                    <div class="col4">
                        <asp:TextBox ID="txtDesc" runat="server" TextMode="MultiLine" Height="60px" 
                            Width="100%" meta:resourcekey="txtDescResource1"
                            ></asp:TextBox>
