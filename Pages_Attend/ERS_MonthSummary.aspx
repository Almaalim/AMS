        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col12">
                    ...
                    <asp:Label ID="lblWorks" runat="server" Text="Works Summary" CssClass="h3" meta:resourcekey="lblWorksResource1"></asp:Label>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col12">
                    <asp:Label ID="lblGaps" runat="server" Text="Gaps Summary" CssClass="h3" meta:resourcekey="lblGapsResource1"></asp:Label>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col12">
                    <asp:Label ID="lblOvertime" runat="server" Text="Overtimes Summary" CssClass="h3" meta:resourcekey="lblOvertimeResource1"></asp:Label>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col12">
                    <asp:Label ID="lblShifts" runat="server" Text="Shifts Summary" CssClass="h3" meta:resourcekey="lblShiftsResource1"></asp:Label>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col12">
                    <asp:Label ID="lblDays" runat="server" Text="Days Summary" CssClass="h3" meta:resourcekey="lblDaysResource1"></asp:Label>
                </div>
            </div>
