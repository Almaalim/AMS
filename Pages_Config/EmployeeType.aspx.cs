...
public partial class EmployeeType : BasePage
{
    
    EmpTypePro ProCs = new EmpTypePro();
    EmpTypeSql SqlCs = new EmpTypeSql();
    ...
    string MainQuery = " SELECT * FROM EmploymentType WHERE ISNULL(EtpDeleted,0) = 0 ";
    
    ...
    public void UILang()
    {
        if (pgCs.LangEn)
        {
            spnEmpTypeEn.Visible = true;
        }
        else
        {
            grdData.Columns[2].Visible = false;
            ddlFilter.Items.FindByValue("EtpNameEn").Enabled = false;
        }

        if (pgCs.LangAr)
        {
            spnEmpTypeAr.Visible = true;
        }
        else
        {
            grdData.Columns[1].Visible = false;
            ddlFilter.Items.FindByValue("EtpNameAr").Enabled = false;
        }
    }
    
    public void UIEnabled(bool pStatus)
    {
        ...
        txtEtpNameAr.Enabled = pStatus;
        txtEtpNameEn.Enabled = pStatus;
        txtEtpDesc.Enabled = pStatus;
    }
    
    void FillPropeties()
    {
        try
        {
            ...
            ProCs.EtpNameEn = txtEtpNameEn.Text;
            ProCs.EtpDesc   = txtEtpDesc.Text;
        ...
        try
        {
            switch (e.CommandName)
            {
                case ("Delete1"):
                    ...
                    DataTable DT = DBCs.FetchData("SELECT * FROM Employee WHERE EtpID = @P1 ", new string[] { ID });
    ...
    protected void PopulateUI(string pID)
    {
        try
        {
            ...
            DataRow[] DRs = DT.Select("EtpID =" + pID + "");

            txtID.Text        = DRs[0]["EtpID"].ToString();
            txtEtpNameAr.Text = DRs[0]["EtpNameAr"].ToString();
            txtEtpNameEn.Text = DRs[0]["EtpNameEn"].ToString();
            txtEtpDesc.Text   = DRs[0]["EtpDesc"].ToString();
        }
        catch (Exception ex) { ErrorSignal.FromCurrentContext().Raise(ex); }
    }
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
