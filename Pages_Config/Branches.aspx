            ...
            <div class="GreySetion">
                ...
                <div class="row">
                    ...
                    <div class="col4">
                        ...
                        <asp:DropDownList ID="ddlBranchManagerID" runat="server" Enabled="False"></asp:DropDownList>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col4">
                        <asp:TextBox ID="txtBranchPoBox" runat="server" AutoCompleteType="Disabled" Enabled="False" onkeypress="return OnlyNumber(event);" meta:resourcekey="txtBranchPoBoxResource1"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="revBranchPoBox" runat="server" ControlToValidate="txtBranchPoBox"
                            EnableClientScript="False" ErrorMessage="Enter Only Numbers" ValidationExpression="^\d+$" CssClass="CustomValidator"
                            ValidationGroup="vgSave"
                            meta:resourcekey="revBranchPoBoxResource1"><img src="../images/Exclamation.gif" title="Enter Only Numbers!" />
