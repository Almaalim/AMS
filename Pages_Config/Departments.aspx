        ...
        <ContentTemplate>
          <%--  <ajaxToolkit:AnimationExtender ID="AnimationExtender1" runat="server" TargetControlID="lnkShow1">
            ...
            <div class="GreySetion">
                <div class="row">
                    <div class="col12">
                                                <asp:Panel runat="server" ID="pnlMyDialogBox" Visible="False" BackColor="#ECE9D8"
                                                    BorderColor="#026AFE" BorderStyle="Ridge" meta:resourcekey="pnlMyDialogBoxResource1">
                                                    <p style="margin-bottom: 5px; font-size: small; font-family: Verdana; color: black;
                                                        height: 51px; width: 377px;">
